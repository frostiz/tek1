/*
** east.c for east.c in /home/roye_v/delivery/maze_solver
** 
** Made by Vincent Roye
** Login   <roye_v@epitech.net>
** 
** Started on  Thu May 11 21:28:35 2017 Vincent Roye
** Last update Sun May 14 17:13:51 2017 Vincent Roye
*/
...
int		east(t_pos *pos, t_list *list,
		     t_coord *coord, char **maze)
{
  if (((pos->y + 1) != coord->width) &&
      maze[pos->x][pos->y + 1] == '*')
    {
